...
define config.name = _("Ryn Editor - Editor Visual de Novelas")
...
define gui.about = _p("""
Editor Visual para Creación de Novelas Visuales

Una herramienta poderosa para crear historias interactivas
...
##
## Configuraciones especiales para que el proyecto se comporte como un editor
## (La configuración principal está en script.rpy)
