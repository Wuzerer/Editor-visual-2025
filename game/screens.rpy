...
screen say(who, what, xpos=None, ypos=None, xalign=None, yalign=None):

    window:
        id "window"

        # Apply custom positioning if provided, otherwise use default styles.
        if xpos is not None:
            xpos xpos
        if ypos is not None:
            ypos ypos
        ...
        text what id "what"
        # Apply custom positioning to the text as well, if provided.
        if xpos is not None:
            xpos xpos
        if ypos is not None:
            ypos ypos
...
screen navigation():
    ## Pantalla de navegación redirigida al editor
    ## Todos los botones redirigen al editor visual
    ...
    vbox:
        ...
        # Todos los botones redirigen al editor
        textbutton _("Editor Visual") action Jump("agradecimiento_editor")
...
screen main_menu():
    ## Pantalla de menú principal redirigida al editor
    ## Esta pantalla se muestra brevemente antes de ir al editor
    ...
    # Redirigir automáticamente al editor
    timer 1.0 action Jump("agradecimiento_editor")
...
# Estilo personalizado para el botón de choice en el editor
...
# Estilos personalizados con outline para el editor visual
style title_with_outline:
    outlines [(2, "#000000", 0, 0)]

style text_with_outline:
